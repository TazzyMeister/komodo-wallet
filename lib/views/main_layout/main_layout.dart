...
class _MainLayoutState extends State<MainLayout> {
  ...
  Future<void> _showNoTradingWarning() async {
    await showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title: Text(LocaleKeys.showNoTradingWarningTitle.tr()),
          content: Text(LocaleKeys.showNoTradingWarningContent.tr()),
          actions: [
            TextButton(
              onPressed: () {
              ...
              child: Text(LocaleKeys.showNoTradingWarningAgree.tr()),
            ),
          ],
        );
      },
